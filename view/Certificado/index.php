...
<br>
        ...
        <div class="form-layout-footer">
            <button class="btn btn-outline-info"><i class="fa fa-download mg-r-10"></i>PNG</button>
            <button class="btn btn-outline-info"><i class="fa fa-download mg-r-10"></i>PDF</button>
        </div>
